...
st.title(":red[Movie Recommender] [:red[$$\\infin$$]](https://github.com/CaptaiN785/Movie-Recommender) ", )
...
def get_results(res):
    ...
    movie_data_link = f"https://api.themoviedb.org/3/movie/{movie_id}?api_key=322a3fce9e15ce917a2578eb7be1da4f"
